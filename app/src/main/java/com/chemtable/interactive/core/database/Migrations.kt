...
object DbMigrations {
    internal val MIGRATION_2_3_SQL: List<String> = listOf(
        ...
        "ALTER TABLE elements ADD COLUMN latin_pronunciation TEXT",
        "ALTER TABLE elements ADD COLUMN english_pronunciation TEXT",
        "ALTER TABLE elements ADD COLUMN discovery_year INTEGER",
        "ALTER TABLE elements ADD COLUMN discoverer TEXT",
        "ALTER TABLE elements ADD COLUMN discovery_country TEXT",
        "ALTER TABLE elements ADD COLUMN cost_per_100g_usd REAL",
        "ALTER TABLE elements ADD COLUMN cost_reference_date TEXT",
        "ALTER TABLE elements ADD COLUMN cas_number TEXT",
        "ALTER TABLE elements ADD COLUMN pubchem_cid TEXT",
        "ALTER TABLE elements ADD COLUMN rtecs_number TEXT",
        """
        ...
        """.trimIndent(),
        "CREATE INDEX IF NOT EXISTS index_isotopes_atomic_number ON isotopes(atomic_number)",
        "CREATE INDEX IF NOT EXISTS index_isotopes_symbol ON isotopes(symbol)",
    )
    ...
    val MIGRATION_3_4: Migration = object : Migration(3, 4) {
        override fun migrate(db: SupportSQLiteDatabase) {
            MIGRATION_3_4_SQL.forEach { statement -> db.execSQL(statement) }
        }
    }
